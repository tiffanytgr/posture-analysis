...
# demo video 
DEMO_VIDEO = 'D:/capstone-running-form/data/good_pose/sample-running-good-1.mp4'
# DEMO_VIDEO = "/Users/anushaagarwal/Desktop/capstone-running-form/data/good_pose/good-video-3.mp4"
...
def main():
    ...
    with open('D:/capstone-running-form/finalized_model.sav','rb') as f:
        clf = pickle.load(f)
    ...
    with mp_holistic.Holistic(min_detection_confidence=detection_confidence) as holistic:   
        while vid.isOpened():
            ...
            try:
                ...
                test = [left_ESH,right_ESH,left_NSH,right_NSH,left_SHK,right_SHK]
                ...
                draw.text((10,65), print_ans, font = font)
                image = cv2.cvtColor(np.array(pil_im), cv2.COLOR_RGB2BGR)
...
# py -m streamlit run d:/capstone-running-form/test-3.py